...
$shelter.clients['Bob'] = Client.new('Bob', 22, 'male', 0, 0)
$shelter.clients['Sue'] = Client.new('Sue', 31, 'female', 2, 0)
$shelter.clients['Jil'] = Client.new('Jil', 46, 'female', 1, 0)
$shelter.clients['Sam'] = Client.new('Sam', 87, 'male', 3, 0)
